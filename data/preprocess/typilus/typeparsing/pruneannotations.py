...
class PruneAnnotationVisitor(TypeAnnotationVisitor):
    ...
    def visit_subscript_annotation(self, node: SubscriptAnnotationNode, current_remaining_depth: int):
    ...
    def visit_attribute_annotation(self, node: AttributeAnnotationNode, current_remaining_depth: int):
        return node
